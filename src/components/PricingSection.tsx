    ...
    <Reveal direction={directions[index]} delay={index * 0.12}>
      ...
      >
        <motion.div
          ...
          className={`relative rounded-2xl border p-8 transition-colors duration-300 ${
            plan.popular
              ? "border-primary/30 bg-gradient-to-b from-primary/[0.04] to-transparent shadow-xl shadow-primary/5 scale-[1.02]"
