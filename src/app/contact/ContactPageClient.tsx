...
const testimonials = [
  { quote: "He built our e-commerce store in just 5 days and it looks better than what other agencies quoted us ₹50,000 for.", author: "Rajesh Mehta", role: "Founder, UrbanCart" },
  { quote: "Our bounce rate dropped by 45% after the redesign. The site loads in under a second and our sales have doubled.", author: "Ananya Sharma", role: "CEO, MediFlow" },
...
export default function ContactPageClient() {
  ...
  return (
    <>
      <Navbar />
      {/* Hero */}
      <section className="relative flex min-h-[40vh] items-center overflow-hidden px-6 pt-40 pb-16 sm:px-8">
        ...
        <div className="relative mx-auto max-w-6xl text-center">
          <Reveal direction="up">
            <span className="mb-4 inline-block rounded-full bg-primary/5 px-4 py-1.5 text-xs font-semibold text-primary">Get in Touch</span>
          </Reveal>
          ...
          <Reveal direction="up" delay={0.3}>
            <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-muted sm:text-lg">
              Ready to take your online presence to the next level? Drop me a message
      ...
      <section className="relative overflow-hidden px-6 py-24 sm:px-8">
        <motion.div className="pointer-events-none absolute top-1/4 -left-16 h-48 w-48 rounded-full border border-primary/5"
          animate={{ y: [0, -30, 0] }} transition={{ duration: 13, repeat: Infinity, ease: "easeInOut" }} />
        <motion.div className="pointer-events-none absolute bottom-1/3 -right-16 h-36 w-36 rounded-full bg-accent/[0.02]"
              ...
              <div className="space-y-6">
                <div>
                  <h2 className="text-2xl font-bold tracking-tight sm:text-3xl">
                    Get a Free <span className="gradient-text">Quote</span>
                  </h2>
                  <p className="mt-3 text-sm leading-relaxed text-muted">
                    Tell me about your project and I&apos;ll provide a custom quote within 24 hours.
                    No obligation, no pressure — just honest advice and transparent pricing.
                  </p>
                </div>

                <a href="https://wa.me/919465568342" target="_blank" rel="noopener noreferrer"
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted">+91 94655 68342</p>
                    <p className="text-xs text-muted">Fastest response time</p>
                  </div>
                </a>
            ...
            <Reveal direction="right" delay={0.3}>
              <form onSubmit={handleSubmit} className="glass-card space-y-5 rounded-2xl p-6 sm:p-8">
                ...
                <p className="text-center text-xs text-muted">
                  Your information is safe. I will never share it with third parties.
                </p>
              </form>
            </Reveal>
          </div>
      ...
      {/* Testimonials */}
      <section className="relative overflow-hidden px-6 py-24 sm:px-8">
        <motion.div className="pointer-events-none absolute -top-10 right-1/4 h-32 w-32 rounded-full border border-primary/5"
          animate={{ y: [0, -25, 0] }} transition={{ duration: 11, repeat: Infinity, ease: "easeInOut" }} />
        <motion.div className="pointer-events-none absolute -bottom-10 left-1/4 h-20 w-20 rounded-2xl bg-accent/[0.02] rotate-12"
          animate={{ y: [0, 15, 0], rotate: [12, 18, 12] }} transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }} />

        <div className="relative mx-auto max-w-6xl">
          <Reveal direction="up">
            <div className="mb-12 text-center">
              <span className="mb-4 inline-block rounded-full bg-primary/5 px-4 py-1.5 text-xs font-semibold text-primary">What Clients Say</span>
      ...
      <section className="relative overflow-hidden px-6 py-24 sm:px-8">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          <Reveal direction="up">
            <h2 className="text-balance text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
              Prefer a Quick Chat? <span className="gradient-text">WhatsApp Me</span>
            </h2>
            <p className="mx-auto mt-4 max-w-xl text-muted">
              I typically respond within minutes on WhatsApp. Let&apos;s discuss your project right now.
            </p>
